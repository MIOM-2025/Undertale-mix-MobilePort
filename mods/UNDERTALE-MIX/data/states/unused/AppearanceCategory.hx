...
var options = [
	...
	['c', 'Southern Seasons', 'Si es marcado, el juego utilizara/el orden de temporadas del/hemisferio sur.'],
	['c', 'Disable Particles', "If checked, particles/will no longer appear."],
	['c', 'Colored Healthbar', "Sure, what the hell.      /If checked, the healthbar will be in/that retro base game look."],
	['c', 'Pixel Perfect Render', "If checked, the camera on songs that/use the Undertale style won't be/pixel perfect."],
